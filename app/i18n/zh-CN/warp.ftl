...
settings-agent-providers-auth-login-codex-import-auth-json = 导入 Codex auth.json
...
settings-agent-providers-codex-import-auth-json-success-toast = 已导入 Codex auth.json：{ $path }
settings-agent-providers-codex-import-auth-json-failed-toast = 导入 Codex auth.json 失败：{ $error }
