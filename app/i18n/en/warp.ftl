...
settings-agent-providers-auth-login-codex-import-auth-json = Import Codex auth.json
...
settings-agent-providers-codex-import-auth-json-success-toast = Imported Codex auth.json: { $path }
settings-agent-providers-codex-import-auth-json-failed-toast = Failed to import Codex auth.json: { $error }
