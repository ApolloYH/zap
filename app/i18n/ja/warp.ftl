...
settings-agent-providers-auth-login-codex-import-auth-json = Codex auth.json をインポート
...
settings-agent-providers-codex-import-auth-json-success-toast = Codex auth.json をインポートしました: { $path }
settings-agent-providers-codex-import-auth-json-failed-toast = Codex auth.json のインポートに失敗しました: { $error }
